    ...
    return (
        <header className="text-purple-500 p-4 rounded-lg font-mono">
            <div className="container mx-auto flex items-center">
                <a href="https://www.linkedin.com/company/code-for-all-qc"><img src={logo} alt="Code for All logo" className="max-w-20 hover:scale-105 ease-in-out duration-300 cursor-pointer" /></a>
                ...
                <nav className={`z-20 mx-auto fixed top-0 left-0 w-full h-full bg-gray-800 pl-4 bg-opacity-75 transform ${isOpen ? 'translate-x-60' : 'translate-x-full'} transition-transform duration-300 ease-in-out md:relative md:translate-x-0 md:flex md:items-center md:bg-transparent md:w-auto md:h-auto md:space-x-4`}>
